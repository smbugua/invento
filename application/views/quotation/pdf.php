	...
	<body>
		<table width="100%" border="1" cellspacing="0" style="border: 1px solid black; border-collapse: collapse">
	        <tbody>
	          ...
	          <tr>
	            <td></td>
	            <td colspan="15"><?php echo $this->lang->line('sales_customer_details'); ?></td>
	            <td></td>
	          </tr>
	          <tr>
	            <td></td>
	            ...
	            <td colspan="9"><?php echo $data[0]->customer_name; ?></td>
	          ...
	          <tr>
	            ...
	            <td colspan="9"><?php echo $data[0]->customer_company; ?></td>
	          ...
	          <tr>
	            <td></td>
	            <td></td>
	            <td colspan="8"><?php echo $data[0]->customer_address; ?></td>
	          ...
	          <tr>
	            <td></td>
	            <td></td>
	            <td colspan="8"><?php echo $data[0]->customer_city.','.$data[0]->customer_postal_code; 
	            				?></td>
	            <td colspan="3"><?php if($data[0]->customer_gstid){echo $data[0]->customer_gstid;} ?></td>
