                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('product/addProduct');?>" encType="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <!--div class="form-group">
                      ...
                      Select Brand
                      <?php echo $this->lang->line('product_select_subcategory'); ?> <span class="validation-color"></span></label>
                    ...
                    <!--div class="form-group">
                      ...
                      <input type="text" class="form-control" id="unit" name="unit" value="<?php echo set_value('unit'); ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="tax"><?php echo $this->lang->line('product_select_product_tax'); ?> </label>
...
//subcategory validation complite.
        ...
        if (!unit.match(name_regex) ) {
          $('#err_unit').text(" Please Enter Valid Product Unit ");   
          return false;
        }
        else{
          $("#err_unit").text("");
...
//porduct price validation complite.
    ...
    $("#unit").on("blur keyup",  function (event){
        ...
        if (!unit.match(name_regex) ) {
          $('#err_unit').text(" Please Enter Valid Product Unit. Ex - Box");   
          return false;
        }
        else{
          $("#err_unit").text("");
