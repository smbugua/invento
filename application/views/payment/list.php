      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $this->lang->line('payment_list_payment'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="index" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th><?php echo $this->lang->line('payment_paying_by'); ?></th>
                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $this->session->userdata('symbol').$row->amount ?></td>
                      <td>
                        <a href="<?php echo base_url('payment/edit/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
